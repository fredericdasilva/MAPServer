...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    <title>
      /branches/release/boost/archive/text_oarchive.hpp –
      Boost C++ Libraries – Trac
    </title>
        <link rel="search" href="/trac/boost/search" />
        <link rel="help" href="/trac/boost/wiki/TracGuide" />
        <link rel="alternate" href="/trac/boost/export/48390/branches/release/boost/archive/text_oarchive.hpp" type="text/plain" title="Original Format" />
  ...
  <body>
    ...
    <br style="clear: both" />
      ...
      <table id="info" summary="Revision info">
        <tr>
          <th scope="col">
            Revision <a href="/trac/boost/changeset/41369">41369</a>, <span title="2913 bytes">2.8 kB</span>
...
Full merge from trunk at revision 41356 of entire boost-root tree. <br />
    ...
    <table class="code"><thead><tr><th class="lineno" title="Line numbers">Line</th><th class="content"> </th></tr></thead><tbody><tr><th id="L1"><a href="#L1">1</a></th><td>#ifndef BOOST_ARCHIVE_TEXT_OARCHIVE_HPP</td></tr><tr><th id="L2"><a href="#L2">2</a></th><td>#define BOOST_ARCHIVE_TEXT_OARCHIVE_HPP</td></tr><tr><th id="L3"><a href="#L3">3</a></th><td></td></tr><tr><th id="L4"><a href="#L4">4</a></th><td>// MS compatible compilers support #pragma once</td></tr><tr><th id="L5"><a href="#L5">5</a></th><td>#if defined(_MSC_VER) &amp;&amp; (_MSC_VER &gt;= 1020)</td></tr><tr><th id="L6"><a href="#L6">6</a></th><td># pragma once</td></tr><tr><th id="L7"><a href="#L7">7</a></th><td>#endif</td></tr><tr><th id="L8"><a href="#L8">8</a></th><td></td></tr><tr><th id="L9"><a href="#L9">9</a></th><td>/////////1/////////2/////////3/////////4/////////5/////////6/////////7/////////8</td></tr><tr><th id="L10"><a href="#L10">10</a></th><td>// text_oarchive.hpp</td></tr><tr><th id="L11"><a href="#L11">11</a></th><td></td></tr><tr><th id="L12"><a href="#L12">12</a></th><td>// (C) Copyright 2002 Robert Ramey - http://www.rrsd.com . </td></tr><tr><th id="L13"><a href="#L13">13</a></th><td>// Use, modification and distribution is subject to the Boost Software</td></tr><tr><th id="L14"><a href="#L14">14</a></th><td>// License, Version 1.0. (See accompanying file LICENSE_1_0.txt or copy at</td></tr><tr><th id="L15"><a href="#L15">15</a></th><td>// http://www.boost.org/LICENSE_1_0.txt)</td></tr><tr><th id="L16"><a href="#L16">16</a></th><td></td></tr><tr><th id="L17"><a href="#L17">17</a></th><td>//  See http://www.boost.org for updates, documentation, and revision history.</td></tr><tr><th id="L18"><a href="#L18">18</a></th><td></td></tr><tr><th id="L19"><a href="#L19">19</a></th><td>#include &lt;ostream&gt;</td></tr><tr><th id="L20"><a href="#L20">20</a></th><td>#include &lt;cstddef&gt; // std::size_t</td></tr><tr><th id="L21"><a href="#L21">21</a></th><td></td></tr><tr><th id="L22"><a href="#L22">22</a></th><td>#include &lt;boost/config.hpp&gt;</td></tr><tr><th id="L23"><a href="#L23">23</a></th><td>#if defined(BOOST_NO_STDC_NAMESPACE)</td></tr><tr><th id="L24"><a href="#L24">24</a></th><td>namespace std{ </td></tr><tr><th id="L25"><a href="#L25">25</a></th><td>    using ::size_t; </td></tr><tr><th id="L26"><a href="#L26">26</a></th><td>} // namespace std</td></tr><tr><th id="L27"><a href="#L27">27</a></th><td>#endif</td></tr><tr><th id="L28"><a href="#L28">28</a></th><td></td></tr><tr><th id="L29"><a href="#L29">29</a></th><td>#include &lt;boost/archive/detail/auto_link_archive.hpp&gt;</td></tr><tr><th id="L30"><a href="#L30">30</a></th><td>#include &lt;boost/archive/basic_text_oprimitive.hpp&gt;</td></tr><tr><th id="L31"><a href="#L31">31</a></th><td>#include &lt;boost/archive/basic_text_oarchive.hpp&gt;</td></tr><tr><th id="L32"><a href="#L32">32</a></th><td></td></tr><tr><th id="L33"><a href="#L33">33</a></th><td>#include &lt;boost/archive/detail/abi_prefix.hpp&gt; // must be the last header</td></tr><tr><th id="L34"><a href="#L34">34</a></th><td></td></tr><tr><th id="L35"><a href="#L35">35</a></th><td>namespace boost { </td></tr><tr><th id="L36"><a href="#L36">36</a></th><td>namespace archive {</td></tr><tr><th id="L37"><a href="#L37">37</a></th><td></td></tr><tr><th id="L38"><a href="#L38">38</a></th><td>template&lt;class Archive&gt;</td></tr><tr><th id="L39"><a href="#L39">39</a></th><td>class text_oarchive_impl : </td></tr><tr><th id="L40"><a href="#L40">40</a></th><td>     /* protected ? */ public basic_text_oprimitive&lt;std::ostream&gt;,</td></tr><tr><th id="L41"><a href="#L41">41</a></th><td>     public basic_text_oarchive&lt;Archive&gt;</td></tr><tr><th id="L42"><a href="#L42">42</a></th><td>{</td></tr><tr><th id="L43"><a href="#L43">43</a></th><td>#ifdef BOOST_NO_MEMBER_TEMPLATE_FRIENDS</td></tr><tr><th id="L44"><a href="#L44">44</a></th><td>public:</td></tr><tr><th id="L45"><a href="#L45">45</a></th><td>#else</td></tr><tr><th id="L46"><a href="#L46">46</a></th><td>    friend class detail::interface_oarchive&lt;Archive&gt;;</td></tr><tr><th id="L47"><a href="#L47">47</a></th><td>    friend class basic_text_oarchive&lt;Archive&gt;;</td></tr><tr><th id="L48"><a href="#L48">48</a></th><td>    friend class save_access;</td></tr><tr><th id="L49"><a href="#L49">49</a></th><td>protected:</td></tr><tr><th id="L50"><a href="#L50">50</a></th><td>#endif</td></tr><tr><th id="L51"><a href="#L51">51</a></th><td>    template&lt;class T&gt;</td></tr><tr><th id="L52"><a href="#L52">52</a></th><td>    void save(const T &amp; t){</td></tr><tr><th id="L53"><a href="#L53">53</a></th><td>        this-&gt;newtoken();</td></tr><tr><th id="L54"><a href="#L54">54</a></th><td>        basic_text_oprimitive&lt;std::ostream&gt;::save(t);</td></tr><tr><th id="L55"><a href="#L55">55</a></th><td>    }</td></tr><tr><th id="L56"><a href="#L56">56</a></th><td>    BOOST_ARCHIVE_DECL(void) </td></tr><tr><th id="L57"><a href="#L57">57</a></th><td>    save(const char * t);</td></tr><tr><th id="L58"><a href="#L58">58</a></th><td>    #ifndef BOOST_NO_INTRINSIC_WCHAR_T</td></tr><tr><th id="L59"><a href="#L59">59</a></th><td>    BOOST_ARCHIVE_DECL(void) </td></tr><tr><th id="L60"><a href="#L60">60</a></th><td>    save(const wchar_t * t);</td></tr><tr><th id="L61"><a href="#L61">61</a></th><td>    #endif</td></tr><tr><th id="L62"><a href="#L62">62</a></th><td>    BOOST_ARCHIVE_DECL(void) </td></tr><tr><th id="L63"><a href="#L63">63</a></th><td>    save(const std::string &amp;s);</td></tr><tr><th id="L64"><a href="#L64">64</a></th><td>    #ifndef BOOST_NO_STD_WSTRING</td></tr><tr><th id="L65"><a href="#L65">65</a></th><td>    BOOST_ARCHIVE_DECL(void) </td></tr><tr><th id="L66"><a href="#L66">66</a></th><td>    save(const std::wstring &amp;ws);</td></tr><tr><th id="L67"><a href="#L67">67</a></th><td>    #endif</td></tr><tr><th id="L68"><a href="#L68">68</a></th><td>    BOOST_ARCHIVE_DECL(BOOST_PP_EMPTY()) </td></tr><tr><th id="L69"><a href="#L69">69</a></th><td>    text_oarchive_impl(std::ostream &amp; os, unsigned int flags);</td></tr><tr><th id="L70"><a href="#L70">70</a></th><td>    BOOST_ARCHIVE_DECL(BOOST_PP_EMPTY()) </td></tr><tr><th id="L71"><a href="#L71">71</a></th><td>    ~text_oarchive_impl(){};</td></tr><tr><th id="L72"><a href="#L72">72</a></th><td>public:</td></tr><tr><th id="L73"><a href="#L73">73</a></th><td>    BOOST_ARCHIVE_DECL(void) </td></tr><tr><th id="L74"><a href="#L74">74</a></th><td>    save_binary(const void *address, std::size_t count);</td></tr><tr><th id="L75"><a href="#L75">75</a></th><td>};</td></tr><tr><th id="L76"><a href="#L76">76</a></th><td></td></tr><tr><th id="L77"><a href="#L77">77</a></th><td>// do not derive from this class.  If you want to extend this functionality</td></tr><tr><th id="L78"><a href="#L78">78</a></th><td>// via inhertance, derived from text_oarchive_impl instead.  This will</td></tr><tr><th id="L79"><a href="#L79">79</a></th><td>// preserve correct static polymorphism.</td></tr><tr><th id="L80"><a href="#L80">80</a></th><td>class text_oarchive : </td></tr><tr><th id="L81"><a href="#L81">81</a></th><td>    public text_oarchive_impl&lt;text_oarchive&gt;</td></tr><tr><th id="L82"><a href="#L82">82</a></th><td>{</td></tr><tr><th id="L83"><a href="#L83">83</a></th><td>public:</td></tr><tr><th id="L84"><a href="#L84">84</a></th><td>     </td></tr><tr><th id="L85"><a href="#L85">85</a></th><td>    text_oarchive(std::ostream &amp; os, unsigned int flags = 0) :</td></tr><tr><th id="L86"><a href="#L86">86</a></th><td>        text_oarchive_impl&lt;text_oarchive&gt;(os, flags)</td></tr><tr><th id="L87"><a href="#L87">87</a></th><td>    {}</td></tr><tr><th id="L88"><a href="#L88">88</a></th><td>    ~text_oarchive(){}</td></tr><tr><th id="L89"><a href="#L89">89</a></th><td>};</td></tr><tr><th id="L90"><a href="#L90">90</a></th><td></td></tr><tr><th id="L91"><a href="#L91">91</a></th><td>typedef text_oarchive naked_text_oarchive;</td></tr><tr><th id="L92"><a href="#L92">92</a></th><td></td></tr><tr><th id="L93"><a href="#L93">93</a></th><td>} // namespace archive</td></tr><tr><th id="L94"><a href="#L94">94</a></th><td>} // namespace boost</td></tr><tr><th id="L95"><a href="#L95">95</a></th><td></td></tr><tr><th id="L96"><a href="#L96">96</a></th><td>// required by export</td></tr><tr><th id="L97"><a href="#L97">97</a></th><td>BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::archive::text_oarchive)</td></tr><tr><th id="L98"><a href="#L98">98</a></th><td></td></tr><tr><th id="L99"><a href="#L99">99</a></th><td>#include &lt;boost/archive/detail/abi_suffix.hpp&gt; // pops abi_suffix.hpp pragmas</td></tr><tr><th id="L100"><a href="#L100">100</a></th><td></td></tr><tr><th id="L101"><a href="#L101">101</a></th><td>#endif // BOOST_ARCHIVE_TEXT_OARCHIVE_HPP</td></tr></tbody></table>
      </div>
      <div id="help">
      ...
      <div id="anydiff">
        <form action="/trac/boost/diff" method="get">
          <div class="buttons">
            <input type="hidden" name="new_path" value="/branches/release/boost/archive/text_oarchive.hpp" />
            <input type="hidden" name="old_path" value="/branches/release/boost/archive/text_oarchive.hpp" />
    ...
    <div id="altlinks">
      ...
      <ul>
        <li class="last first">
          <a rel="nofollow" href="/trac/boost/export/48390/branches/release/boost/archive/text_oarchive.hpp">Original Format</a>
        </li>
      </ul>
    </div>
    </div>
